...
_p[7] = {
    value: function(require, exports, module) {
        ...
        connect.register("under", function(node, parent, connection, width, color) {
            ...
            var L01 = {
                x: p3.x > p1.x ? p1.x : p1.x,
                y: p3.y < p1.y ? p3.y + rect.y : p3.y - rect.y
            };
            var Q01 = {
                x: p1.x,
                y: p3.y
        ...
        var OrderHinter = kity.createClass("OrderHinter", {
            ...
            render: function(hint) {
                ...
                if (hint) {
                    ...
                    this.path.stroke(hint.node.getStyle("order-hint-path-color") || "#ccc", hint.node.getStyle("order-hint-path-width") || 1);
                }
            }
        });
         ...
         */
            ...
            var Expander = kity.createClass("Expander", {
                ...
                constructor: function(node) {
                    this.callBase();
                    this.radius = 6;
                    this.outline = new kity.Circle(this.radius).stroke("gray").fill("gray");
                    this.sign = new kity.Path().stroke("white");
    ...
    value: function(require, exports, module) {
        ...
        var WireframeRenderer = kity.createClass("WireframeRenderer", {
            ...
            create: function() {
                ...
                var box = this.wireframe = new kity.Rect().stroke("green");
